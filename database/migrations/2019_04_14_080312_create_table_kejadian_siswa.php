    ...
    public function up()
    {
        ...
        $data = array(
            [
                'id_siswa' => '1',
                'id_kejadian' => '1',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-01-23 11:53:20'),
            ...
            [
                'id_siswa' => '1',
                'id_kejadian' => '3',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-02-24 11:54:20'),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'id_siswa' => '1',
                'id_kejadian' => '4',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-03-25 11:55:20'),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'id_siswa' => '2',
                'id_kejadian' => '3',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-04-26 11:56:20'),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'id_siswa' => '2',
                'id_kejadian' => '3',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-05-27 11:57:20'),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'id_siswa' => '2',
                'id_kejadian' => '7',
                'tanggaljam_kejadian' => Carbon::createFromFormat('Y-m-d H:i:s', '2018-06-28 11:58:20'),
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
        );
