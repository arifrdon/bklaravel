...
return [
    ...
    */
    ...
    'custom' => [
        'nama_kejadian' => [
            'required' => 'Kolom nama kejadian harus diisi',
        ],
        'poin_kejadian' => [
            'required' => 'Kolom poin kejadian harus diisi',
        ...
        'id_kejadian' => [
            'required' => 'Pilihan Kejadian harus diisi',
        ],
        'tanggal_kejadian' => [
            'required' => 'Kolom tanggal kejadian harus diisi',
        ],
        'jam_kejadian' => [
